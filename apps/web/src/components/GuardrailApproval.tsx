          ...
          {showDenyInput && !decision && (
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/12 bg-black/40 px-2.5 py-2 text-xs text-white outline-none focus:border-white/30"
              />
            </motion.div>
          )}

          {errorMessage && (
            <div className="flex items-center gap-1.5 rounded-xl border border-rose-500/30 bg-rose-500/10 px-3 py-2 text-xs text-rose-300">
