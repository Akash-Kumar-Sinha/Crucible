...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-white/8 bg-zinc-950/60 text-zinc-100 shadow-sm backdrop-blur-sm transition-colors",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center p-5 sm:p-6 pt-0 border-t border-white/8",
      className,
    )}
    {...props}
  />
