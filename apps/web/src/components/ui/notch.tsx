...
function NotchDivider() {
  return (
    <span
      ...
      style={{
        backgroundImage:
          "repeating-linear-gradient(180deg, rgba(255,255,255,0.2) 0px, rgba(255,255,255,0.2) 1px, transparent 1px, transparent 4px)",
...
export const Notch = ({
          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                active
                  ? "text-zinc-950 bg-white border border-zinc-900"
            ...
            >
              ...
              {active ? (
                <span className="size-1.5 shrink-0 rounded-full bg-zinc-950" />
              ) : null}
            </motion.button>
          );
        })}
        ...
        return (
          <React.Fragment key={item.id}>
            <button
              ...
              className={cn(
                "group flex items-center gap-2 rounded-sm px-3 py-1.5 text-xs font-medium whitespace-nowrap text-zinc-300 transition-colors hover:bg-white/5 hover:text-white",
                itemClassName,
              )}
            >
              {item.icon ? (
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 z-100 flex translate-z-0 px-4 group",
    ...
    >
      <motion.div
        ...
        className={cn(
          "pointer-events-auto flex w-fit flex-col overflow-hidden rounded-lg border-2 group group-hover:border-white border-zinc-300 bg-neutral-950/95 shadow-[0_12px_40px_-8px_rgba(0,0,0,0.55)] ring-1 ring-neutral-800 backdrop-blur-2xl ring-inset",
          className,
        )}
      >
