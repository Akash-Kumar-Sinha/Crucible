      ...
      <CardContent>
        ...
        {displaySpans.length === 0 ? (
          ...
          <div className="relative">
                      ...
                      className={`cursor-pointer transition-all duration-150 ${
                        isError
                          ...
                          : span.name.startsWith("tool.")
                            ? "fill-zinc-200 hover:fill-white"
                            : span.name.includes("model")
                              ? "fill-zinc-400 hover:fill-zinc-300"
            ...
            {hoveredSpan && (
              <div className="absolute top-2 right-2 rounded-lg border border-white/8 bg-zinc-900/95 px-3 py-1.5 text-xs shadow-lg backdrop-blur font-mono">
