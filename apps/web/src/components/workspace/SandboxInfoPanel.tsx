...
export function SandboxInfoPanel({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-3xl lg:max-w-4xl w-[92vw] max-h-[88vh] flex flex-col p-6 overflow-hidden bg-zinc-950 border-white/10">
        <DialogHeader className="shrink-0 pb-2">
          <div className="flex items-start justify-between gap-3 pr-8">
            <div className="flex items-start gap-2.5">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/8 bg-white/5 text-zinc-300">
                <Shield size={18} />
              </div>
              <div>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto max-h-[calc(88vh-140px)] pr-1.5 py-1">
          {error && (
            <div
              style={{
                padding: "10px 14px",
