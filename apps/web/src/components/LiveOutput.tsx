    ...
    >
      <Message align="start" className="w-full">
        ...
        <MessageContent className="items-start w-full">
          ...
          <div className="w-full max-w-[88%] sm:max-w-[82%] rounded-2xl rounded-tl-sm p-4 sm:p-5 bg-zinc-900/80 border border-white/10 shadow-xl backdrop-blur-xl space-y-3">
            {isScalingUp && (
              <div className="rounded-xl border border-violet-500/20 bg-violet-500/10 px-4 py-3 text-violet-200 space-y-2">
            ...
            {streamingThought && (
              ...
              >
                ...
                >
                  ...
                  <AccordionContent className="border-t border-white/5 px-4 py-3 text-xs text-zinc-400 whitespace-pre-wrap leading-relaxed">
                    {streamingThought}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
