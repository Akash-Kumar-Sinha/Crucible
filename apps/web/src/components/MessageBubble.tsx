    ...
    return (
      ...
      >
        ...
        <Accordion defaultValue="obs" className="w-full">
          <AccordionItem
            value="obs"
            className="rounded-xl border border-white/8 bg-black/80 shadow-md"
          >
            ...
            {thoughtText ? (
              ...
              >
                ...
                >
                  ...
                  <AccordionContent className="p-3.5 text-xs leading-relaxed text-zinc-400 whitespace-pre-wrap">
                    {thoughtText}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
                ...
                {message.toolCalls.map((tc, tcIndex) => {
                  ...
                  return (
                    ...
                    >
                      <AccordionItem
                        value={`tc-${tcIndex}`}
                        className="rounded-xl border border-white/8 bg-black"
                      >
                        <AccordionTrigger className="p-3 hover:bg-zinc-900/60 text-zinc-400">
                          <div className="flex items-center gap-2">
